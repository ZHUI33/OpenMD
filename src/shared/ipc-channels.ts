export const IPC_CHANNELS = Object.freeze({
  ...
  recoveryGetSnapshot: 'openmd:recovery:get-snapshot',
  recoverySaveSession: 'openmd:recovery:save-session',
  recoveryClearRecord: 'openmd:recovery:clear-record',
  recoveryRestoreWorkspace: 'openmd:recovery:restore-workspace',
  recoveryDiscard: 'openmd:recovery:discard',
  recoveryCompleteSession: 'openmd:recovery:complete-session',
  ...
  workspaceSearchCancel: 'openmd:workspace:search-cancel',
